...
load_model(model, '/mnt/DATA/GRADUATION_RESEARCH/Workstation_Sources/ObjectDetection/CenterNet/CenterNet-converter/src/ctdet_coco_dla_2x.pth')
model.eval()
model.cuda()
input = torch.zeros([1, 3, 512, 512]).cuda()
onnx.export(model, input, "/mnt/DATA/GRADUATION_RESEARCH/Workstation_Sources/ObjectDetection/CenterNet/CenterNet-converter/src/ctdet_coco_dla_2x.onnx", verbose=True,
